        ...
        if owner:
            dm_embed = discord.Embed(
                ...
                description=(
                    ...
                    "1. Run /automod and choose what to moderate (spam, links, toxicity)\n"
                    "2. Run /setlevelchannel to set where level-up messages appear\n"
                    "3. Run /ticketsetup then /ticketpanel to create a support panel\n\n"
                    "**Full dashboard:**\n"
                    "https://luxebot-production.up.railway.app\n\n"
